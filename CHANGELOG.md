...
### Changed
- **Workload-driven Semantic RAG reliability**: knowledge-base answers are now more robust for complex, multi-evidence questions, with evidence-grounded semantic relation recall, clearer applicability limits, full-evidence follow-up reads, and stronger protection against stale or unauthorized KB evidence appearing in agent responses.
...
### Changed
- **Unified Realtime Updates**: chat, Jinshu, and public experience updates now share one persistent notification connection, reducing redundant background connections and refreshes
...
### Changed
- **Proactive Chat Quality**: agents autonomously initiating conversations now operate with clearer intention and more relevant context — external event understanding and internal self-awareness are handled through separate cognitive paths, improving the naturalness and pertinence of self-initiated messages
